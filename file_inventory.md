...
| `archive/fix_scripts/fix_chatgpt_issues_2_to_6.py` | One-shot fix script — first ChatGPT review. Archived. | current | 2026-02-26 |
| `archive/fix_scripts/fix_section6_cleanup.py` | One-shot fix script — second ChatGPT review. Archived. | current | 2026-02-26 |
| `archive/fix_scripts/fix_third_review.py` | One-shot fix script — third ChatGPT review. Archived. | current | 2026-02-26 |
| `archive/fix_scripts/fix_fourth_review.py` | One-shot fix script — fourth ChatGPT review. Archived. | current | 2026-02-26 |
| `archive/fix_scripts/fix_fifth_review.py` | One-shot fix script — fifth ChatGPT review. Archived. | current | 2026-02-26 |
| `archive/fix_scripts/fix_sixth_review.py` | One-shot fix script — sixth ChatGPT review. Archived. | current | 2026-02-26 |
| `archive/fix_scripts/fix_seventh_review.py` | One-shot fix script — seventh ChatGPT review. Archived. | current | 2026-02-26 |
| `archive/fix_scripts/fix_eighth_review.py` | One-shot fix script — eighth ChatGPT review. Archived. | current | 2026-02-26 |
...
| `project_documentation` | Comprehensive methodology and architecture overview — pre-v2 content. Do not cite; use README.md instead. | outdated | 2026-02-24 |
...
| `significance_draft_v1` (md + docx) | Significance Magazine article draft (~1,480 words). Describes retired exact combinatorial test throughout; needs full method rewrite before submission. Do not cite or share. | outdated | 2026-02-26 |
...
| `project_documentation.docx` | Comprehensive project overview — pre-v2 content. Do not cite; use README.md instead. | outdated | 2026-02-21 |
...
| File | Description | Status | Last modified |
|------|-------------|--------|---------------|
| `requirements.txt` | Python dependencies. Includes python-docx>=1.1.0, streamlit, pandas, plotly, openpyxl, numpy, statsmodels. | current | 2026-02-26 |
